...
type AppRole = "admin" | "zonal" | "supervisor" | "promotor";
    ...
    items: [
      {
        ...
        label: "Personal",
        icon: faPeopleGroup,
        href: "/dashboard?module=personal",
        permissions: [PERMISSIONS.peopleRead],
      },
      {
        key: "tiendas",
        label: "Tiendas",
      ...
      },
      {
        ...
        label: "Territorio",
        icon: faGlobe,
        href: "/dashboard?module=territorio",
        permissions: [PERMISSIONS.territoryRead],
      },
      {
        key: "seguridad",
        label: "Seguridad",
        icon: faShieldHalved,
        href: "/dashboard?module=seguridad",
...
export function AppShell({
  ...
  const sidebar = (
    ...
    >
      <div className="flex h-16 items-center border-b border-slate-800 px-4">
        <Link
          href="/dashboard"
          onClick={() => activeModule !== "resumen" && setNavigating(true)}
  ...
  return (
    <div className="flex min-h-screen bg-[#f5f6f8] text-slate-950">
      {navigating && <LoadingIndicator overlay message="Cambiando de vista..." />}
          ...
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2 text-[11px] font-medium uppercase tracking-[0.14em] text-slate-400">
                <span>AdminGes</span>
                {activeView && <><span>/</span><span>{activeView}</span></>}
              </div>
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="hidden min-w-0 sm:block">
                  ...
                  <div className="text-[10px] text-slate-500">{roleName(role)}</div>
                </div>
